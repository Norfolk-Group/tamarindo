...
import { IcpCatalogWorkspace } from "@/components/nico/icp-catalog-workspace";
import { PrimaryWorkspace } from "@/components/nico/primary-columns";
import {
        ...
        <header className="relative flex h-14 shrink-0 items-center gap-3 border-b border-border px-5">
          ...
          <div className="min-w-0">
            <p className="flex items-center gap-1.5 text-sm font-semibold leading-tight">
              Nico
              <InfoTip topic="conversation.nico" />
            </p>
            <p
