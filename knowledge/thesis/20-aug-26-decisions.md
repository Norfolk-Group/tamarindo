...
| Asset classes | Homes **and** vehicles, **same launch**, not staggered | FACT |
...
| Down | 40% | FACT |
| Credit | FICO 780+, SSN, individuals only (no LLC) | FACT |
| Default cite | ~1.5% at 780+; ~8% below | CONTEXT (Dov/Mike, not a Tamarindo book) |
| Pricing target | ~500 bps over IBOR | FACT — gross vs net of OpCo fees **open** |
| OpCo take | 2% activation on each draw + 20% of profits | FACT |
| Aviation | **Out of the Intervest-pilot model** | FACT |
...
- **Aircraft in the catalog / `aircraftStartMonth`.** Thesis 09 already
  said "enter no aircraft volume in the base case." Aug 26 is stronger:
  aviation is **removed from the Intervest-pilot story**, not merely
  zeroed. Keep the two aircraft ICPs as a what-if book. Do not pitch
  aircraft to Intervest.
...
- Whether 500 bps over IBOR is gross or net of the 2 + 20 (Dov).
